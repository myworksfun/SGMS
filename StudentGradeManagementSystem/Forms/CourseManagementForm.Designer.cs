namespace StudentGradeManagementSystem.Forms
{
    partial class CourseManagementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtDescription = new AntdUI.TextBox();
            this.label8 = new AntdUI.Label();
            this.txtType = new AntdUI.TextBox();
            this.label7 = new AntdUI.Label();
            this.numCredit = new System.Windows.Forms.NumericUpDown();
            this.label6 = new AntdUI.Label();
            this.txtName = new AntdUI.TextBox();
            this.label5 = new AntdUI.Label();
            this.txtCourseId = new AntdUI.TextBox();
